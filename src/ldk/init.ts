...
import { createEventHandler, type PaymentEventCallback, type ChannelEventCallback } from './traits/event-handler'
...
export interface InitResult {
  ...
  setChannelCallback: (cb: ChannelEventCallback | undefined) => void
}
...
async function doInitializeLdk(ldkSeed: Uint8Array): Promise<InitResult> {
  ...
  return {
    ...
    setChannelCallback: (cb: ChannelEventCallback | undefined) => {
      channelCallback = cb
    },
  }
}
